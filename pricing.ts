...
export const DEFAULT_PRICING_CONFIG: PricingConfig = {
  ...
  '웰그린': {
    ...
    products: {
      ...
      '제주 구좌 당근 특 3kg': { supplyPrice: 6000, sellingPrice: 8250, margin: 1288, displayName: '제주 구좌 당근 특 3kg' },
      '제주 구좌 당근 중 5kg': { supplyPrice: 7000, sellingPrice: 11230, margin: 2921, displayName: '제주 구좌 당근 중 5kg' },
      '제주 구좌 당근 상 5kg': { supplyPrice: 7700, sellingPrice: 11890, margin: 2804, displayName: '제주 구좌 당근 상 5kg' },
      '제주 구좌 당근 특 5kg': { supplyPrice: 8400, sellingPrice: 11730, margin: 1962, displayName: '제주 구좌 당근 특 5kg' },
      '제주 구좌 당근 중 10kg': { supplyPrice: 10500, sellingPrice: 14800, margin: 2574, displayName: '제주 구좌 당근 중 10kg' },
      '제주 구좌 당근 상 10kg': { supplyPrice: 11500, sellingPrice: 16800, margin: 3341, displayName: '제주 구좌 당근 상 10kg' },
      '제주 구좌 당근 특 10kg': { supplyPrice: 12500, sellingPrice: 17800, margin: 3225, displayName: '제주 구좌 당근 특 10kg' },
      '제주 구좌 당근 왕 3kg': { supplyPrice: 5000, sellingPrice: 7850, margin: 1935, displayName: '제주 구좌 당근 왕 3kg' },
      '제주 구좌 당근 왕 5kg': { supplyPrice: 6300, sellingPrice: 9400, margin: 2004, displayName: '제주 구좌 당근 왕 5kg' },
      '제주 구좌 당근 왕 10kg': { supplyPrice: 9500, sellingPrice: 13800, margin: 2691, displayName: '제주 구좌 당근 왕 10kg' },
      ...
      '★A급 가정용 부사사과 2kg내외 13-15과': { supplyPrice: 8250, sellingPrice: 10900, margin: 1379, displayName: '★A급 가정용 부사사과 2kg내외 13-15과' },
      '★A급 가정용 부사사과 3kg내외 17-20과': { supplyPrice: 12450, sellingPrice: 17800, margin: 3275, displayName: '★A급 가정용 부사사과 3kg내외 17-20과' },
      '★A급 가정용 부사사과 5kg내외 27-32과': { supplyPrice: 17650, sellingPrice: 23800, margin: 3375, displayName: '★A급 가정용 부사사과 5kg내외 27-32과' },
      '★A급 가정용 부사 사과 10kg내외 51-65과': { supplyPrice: 32500, sellingPrice: 43500, margin: 5928, displayName: '★A급 가정용 부사 사과 10kg내외 51-65과' },
  ...
  '고랭지김치': {
    ...
    products: {
      '3kg': { supplyPrice: 16300, sellingPrice: 21600, margin: 2781, displayName: '3kg' },
      '5kg': { supplyPrice: 21300, sellingPrice: 33600, margin: 8382, displayName: '5kg' },
      '7kg': { supplyPrice: 25600, sellingPrice: 41000, margin: 10619, displayName: '7kg' },
      '10kg': { supplyPrice: 33000, sellingPrice: 52800, margin: 13644, displayName: '10kg' }
    }
  },
  '답도': {
    deadline: '10:00',
  ...
  '제이제이': {
    ...
    products: {
      ...
      '제주 순살 갈치 5마리': { supplyPrice: 15500, sellingPrice: 23800, margin: 5525, displayName: '제주 순살 갈치 5마리' },
      '제주 은갈치 5마리 (중)': { supplyPrice: 19000, sellingPrice: 26800, margin: 4675, displayName: '제주 은갈치 5마리 (중)' },
      '제주 은갈치 5마리 (대)': { supplyPrice: 35500, sellingPrice: 46500, margin: 5578, displayName: '제주 은갈치 5마리 (대)' },
