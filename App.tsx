      ...
      {quotaExceeded && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
          <div className="bg-zinc-900 border border-red-500/60 rounded-2xl p-8 max-w-sm w-full mx-4 shadow-2xl text-center">
            ...
            <p className="text-zinc-300 text-sm leading-relaxed mb-1">오늘 사용 가능한 Firestore 읽기/쓰기 횟수를 모두 소진했어요. 저장된 데이터는 안전하며, 한도가 풀리면 그대로 다시 보입니다.</p>
            <p className="text-zinc-500 text-xs leading-relaxed mb-1">무료(Spark) 요금제 한도는 <span className="text-zinc-300">한국시간 오후 4~5시</span>(태평양 자정)에 자동 초기화됩니다. 그때까지 재시도는 5분 간격으로 늦춰집니다.</p>
            <p className="text-zinc-500 text-xs leading-relaxed mb-6">계속 반복되면 Firebase 콘솔에서 <span className="text-zinc-300">Blaze 요금제</span>로 올리면 한도 벽이 사라집니다(사용량 적으면 월 몇백 원).</p>
